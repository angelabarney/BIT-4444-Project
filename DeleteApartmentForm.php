...
if (isset($_POST["submit"])) {
  if (isset($_POST["Apartment_ID"])) $Apartment_ID = $_POST["Apartment_ID"];
    ...
    if(!empty($Apartment_ID)) {
      ...
      header("Location: deleteapartment.php");
    } else {
      $err = true;
    }
  }
...
<h1>Delete Apartment Profile</h1>

<form method="post" action="<?php echo $_SERVER['PHP_SELF']?>">
  <label>Enter Apartment ID to Delete:<br />
       <input type="number" name="Apartment_ID" value="<?php if(!empty($Apartment_ID) && $Apartment_ID>0) echo $Apartment_ID; ?>" /><br />
     </label>
     <br />
